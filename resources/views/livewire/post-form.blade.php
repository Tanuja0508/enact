    ...
    <div>
        <div class="container mx-auto">
            <form method="POST" wire:submit.prevent="storePost">
                ...
                <button type="submit" class="px-4 py-2 mt-4  bg-blue-600 rounded">
                    Submit
                </button>
                <button type="submit" wire:click="update" class="px-4 py-2  bg-indigo-600 rounded">
                    Update
                </button>
            </form>
        </div>
                    ...
                    <table class="min-w-full">
                        ...
                        <tbody class="bg-white">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 border-b border-gray-200">
                                    <button wire:click="edit({{ $post->id }})" class="px-4 py-2  bg-blue-600">
                                        Edit
                                    </button>
                                </td>
